...
-- select first_name, gender, hire_date from employees limit 0, 5; -> top 5 출력됨
...
-- distinct, 중복 제거
-- 예제 4 : titles 테이블에서 직급은 어떤 것들이 있는지 직급이름을 한 번씩만 출력
...
-- 예제 4 : 직원의 사번, 월급을 사번순(asc), 월급순(desc)로 출력
